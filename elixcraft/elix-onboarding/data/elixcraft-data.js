...
window.ELIXCRAFT_JOBS = {
  ...
  "factions": {
    "protoss": {
      "label": "TECHNOLOGY", "department": "Engineering & Technology", "color": "#ffd700",
      "lore": "Elite professionals driving innovation. High impact, maximum value.",
      "tracks": [
    ...
    "terran": {
      "label": "OPERATIONS", "department": "Operations & Finance", "color": "#4a9eff",
      "lore": "Versatile professionals building organisational foundations. Masters of logistics, process, and finance.",
      "tracks": [
    ...
    "zerg": {
      "label": "GROWTH", "department": "Sales, Marketing & People", "color": "#b44fff",
      "lore": "Driving expansion through velocity, market development, and collaborative intelligence.",
      "tracks": [
...
window.ELIXCRAFT_INDUSTRIES = {
  ...
  sectors: [
    ...
    // ── ALPHA: People & Consumer ──────────────────────────────────────────
    {
      ...
      faction: "zerg", factionBonus: "GROWTH +20% ADAPTABILITY — High-velocity consumer campaigns across SEA",
    ...
    },
    {
      ...
      faction: "zerg", factionBonus: "GROWTH +15% GROWTH SPEED — Volume-driven, people-intensive expansion",
    ...
    },
    {
      ...
      faction: "zerg", factionBonus: "GROWTH +25% CHA — High-energy event execution and stakeholder relations",
    ...
    },
    {
      ...
      faction: "multi", factionBonus: "ALL DIVISIONS — Essential services across every domain of the organisation",
    ...
    // ── BETA: Industrial & Physical ───────────────────────────────────────
    {
      ...
      faction: "terran", factionBonus: "OPERATIONS +20% STR — Process mastery and operational precision",
    ...
    },
    {
      ...
      faction: "terran", factionBonus: "OPERATIONS +15% DEX — Structural precision and project delivery at scale",
    ...
    },
    {
      ...
      faction: "terran", factionBonus: "OPERATIONS +25% ADAPTABILITY — Masters of movement, flow, and inventory",
    ...
    },
    {
      ...
      faction: "terran", factionBonus: "OPERATIONS +10% TECH DEPTH — Mechanical precision and diagnostic expertise",
    ...
    // ── GAMMA: Tech & Finance ──────────────────────────────────────────────
    {
      ...
      faction: "protoss", factionBonus: "TECHNOLOGY +30% TECH DEPTH — Advanced systems mastery · HOME SECTOR BONUS",
    ...
    },
    {
      ...
      faction: "protoss", factionBonus: "TECHNOLOGY +20% INT — Strategic analytical precision in regulated markets",
      description: "Fintech innovators, investment bankers, corporate banking, insurance and asset management specialists. MAS's digital banking licences drive new technology demand.",
    ...
    },
    {
      ...
      faction: "protoss", factionBonus: "TECHNOLOGY +25% INT — Innovation-driven clean tech mastery under SG Green Plan 2030",
    ...
    },
    {
      ...
      faction: "protoss", factionBonus: "TECHNOLOGY +30% PRECISION — Elite zero-fault-tolerance systems, MRO hub expansion",
    ...
    // ── DELTA: Specialized & Public ───────────────────────────────────────
    {
      ...
      faction: "terran", factionBonus: "OPERATIONS +20% STABILITY — Process-driven public administration and policy execution",
    ...
    },
    {
      ...
      faction: "protoss", factionBonus: "TECHNOLOGY +25% PRECISION — High-skill, low-error critical care roles",
    ...
    },
    {
      ...
      faction: "multi", factionBonus: "TECHNOLOGY +cyber · OPERATIONS +physical — Dual-domain threat response capability",
    ...
    },
    {
      ...
      faction: "multi", factionBonus: "ALL DIVISIONS — ESG compliance now mandatory for SGX-listed companies",
...
window.ELIXCRAFT_BENEFITS = {
  ...
  "packages": [
    ...
    // ── BRONZE: Starter Package (LVL 1) ──────────────────────────────────
    { "id": "starter", "name": "Starter Package", "tier": "BRONZE", "color": "#cd7f32", "unlock_level": 1,
      "lore": "MOM-compliant entry package. Covers all statutory minimums to get your team member onboarded.",
      "slots": [
    ...
    { "id": "professional", "name": "Professional Package", "tier": "SILVER", "color": "#a8a8a8", "unlock_level": 4,
      "lore": "Competitive mid-career benefits package. Exceeds statutory minimums to retain experienced team members.",
      "slots": [
    ...
    { "id": "elite", "name": "Elite Package", "tier": "GOLD", "color": "#ffd700", "unlock_level": 7,
      "lore": "Top-tier benefits package for high-value team members. Maximises retention and performance.",
      "slots": [
    ...
    // ── PLATINUM: Executive Package (LVL 11) ─────────────────────────────
    { "id": "commander", "name": "Executive Package", "tier": "PLATINUM", "color": "#b0e0ff", "unlock_level": 11,
      "lore": "Reserved for senior leadership. Designed to retain your most valuable and irreplaceable team members.",
      "slots": [
